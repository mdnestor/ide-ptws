...
\section{Examples}
In this section, we construct the periodic traveling wave solution for uniform and Laplace kernels and derive formulas for $c^*$ in terms of the model parameters. The source code is available at \url{https://github.com/mdnestor/ide-ptws}.
